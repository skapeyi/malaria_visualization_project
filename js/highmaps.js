(function () {
    ...
    function N(a, b, c) {
        ...
        else if (t(b) && ga(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function oa(a) {
        return Ha(a) ? a : [a]
    ...
    function G(a, b) {
        if (Aa && !ca && b && b.opacity !== s) b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        q(a.style, b)
    }
    function $(a, b, c, d, e) {
        a = A.createElement(a);
    ...
    function Ia(a, b) {
        ...
        (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = F.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = ua(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Za(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    var s, A = document,
        ...
        Ma, Sa, Bb = {},
        ib = 0,
        ab, F, Za, ia, jb, Na, ma, aa = function () {
            return s
        },
        W = [],
        Ta = 0,
            ...
            init: function (b) {
                ...
                a.each(["cur", "_default", "width", "height", "opacity"], function (a, b) {
                    ...
                    (k = e[b]) && (e[b] = function (c) {
                        var d, c = a ? c : this;
                        if (c.prop !== "align") return d = c.elem, d.attr ? d.attr(c.prop, b === "cur" ? s : c.now) : k.apply(this, arguments)
                    })
                });
                ...
                a.fn.highcharts = function () {
                    ...
                    if (this[0]) {
                        ...
                        c = b[0];
                        if (c !== s) c.chart = c.chart || {}, c.chart.renderTo = this[0], new K[a](c, b[1]), d = this;
        ...
        plotOptions: {
            line: {
                ...
                dataLabels: y(O, {
                    ...
                    enabled: !1,
                    formatter: function () {
                        return this.y === null ? "" : ua(this.y, -1)
                    },
        ...
        fa = function (a) {
            ...
            (function (a) {
                a && a.stops ? d = Ua(a.stops, function (a) {
                    return fa(a[1])
                }) : (c = Nb.exec(a)) ? b = [z(c[1]), z(c[2]), z(c[3]), parseFloat(c[4], 10)] : (c = Ob.exec(a)) ? b = [z(c[1], 16), z(c[2], 16), z(c[3], 16), 1] : (c = Pb.exec(a)) && (b = [z(c[1]), z(c[2]), z(c[3]), 1])
            })(a);
            return {
                get: function (c) {
                    var f;
    ...
    T.prototype = {
        ...
        colorGradient: function (a, b, c) {
            ...
            if (f) {
                ...
                for (o in g) o !== "id" && v.push(o, g[o]);
                for (o in j) v.push(j[o]);
                v = v.join(",");
                h[v] ? a = h[v].attr("id") : (g.id = a = "highcharts-" + ib++, h[v] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], p(j, function (a) {
        ...
        getBBox: function () {
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    ...
                    if (e) a.width = P(d * wa(g)) + P(c * qa(g)), a.height = P(d * qa(g)) + P(c * wa(g))
                }
                this.bBox = a;
                h && (b.cache[h] = a)
            }
        ...
        add: function (a) {
            ...
            if (c.handleZ) {
                a = d.childNodes;
                for (g = 0; g < a.length; g++) if (b = a[g], c = N(b, "zIndex"), b !== e && (z(c) > f || !t(f) && t(c))) {
                    d.insertBefore(e, b);
                    h = !0;
                    break
                }
        ...
        shadow: function (a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) N(f, "height", u(N(f, "height") - h, 0)), f.cutHeight = h;
    ...
    T.prototype.translateXSetter = T.prototype.translateYSetter = T.prototype.rotationSetter = T.prototype.verticalAlignSetter = T.prototype.scaleXSetter = T.prototype.scaleYSetter = function (a, b) {
        this[b] = a;
        this.doTransform = !0
    };
    T.prototype["stroke-widthSetter"] = T.prototype.strokeSetter = function (a, b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"]) this.strokeWidth = this["stroke-width"], T.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
    ...
    ba.prototype = {
        ...
        buildText: function (a) {
            for (var b = a.element, c = this, d = c.forExport, e = m(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = N(b, "x"), k = a.styles, l = a.textWidth, n = k && k.lineHeight, o = k && k.HcTextStroke, v = g.length, J = function (a) {
                    return n ? z(n) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
                }; v--;) b.removeChild(g[v]);
            !f && !o && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), p(e, function (e, f) {
                var g, n = 0,
                ...
                p(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            if (l) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), o = n || e.length > 1 && k.whiteSpace !== "nowrap", p, C, s = k.HcHeight, q = [], t = J(v), Db = 1; o && (e.length || q.length);) delete a.bBox, p = a.getBBox(), C = p.width, !ca && c.forExport && (C = c.measureSpanWidth(v.firstChild.data, a.styles)), p = C > l, !p || e.length === 1 ? (e = q, q = [], e.length && (Db++, s && Db * t > s ? (e = ["..."], a.attr("title", a.textStr)) : (v = A.createElementNS(ya, "tspan"), N(v, {
                                dy: t,
                                x: j
        ...
        button: function (a, b, c, d, e, f, g, h, i) {
            ...
            E(j.element, Aa ? "mouseout" : "mouseleave", function () {
                k !== 3 && (l = [e, f, g][k], n = [o, v, m][k], j.attr(l).css(n))
            });
        ...
        symbol: function (a, b, c, d, e, f) {
            ...
            }, j = a.match(i)[1], a = Bb[j], g = this.image(j).attr({
                x: b,
                y: c
        ...
        label: function (a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (mb) {
                    if (!m) a = w(-Q * x), b = h ? -lb : 0, o.box = m = d ? n.symbol(d, a, b, o.width, o.height, L) : n.rect(a, b, o.width, o.height, 0, L[Jb]), m.attr("fill", U).add(o);
                    m.isImg || m.attr(q({
                        width: w(o.width),
                        height: w(o.height)
                    }, L));
            ...
            function k() {
                var a = o.styles,
                    ...
                    c;
                c = h ? 0 : lb;
                if (t(Pa) && C && (a === "center" || a === "right")) b += {
                    center: 0.5,
                    right: 1
                }[a] * (Pa - C.width);
                if (b !== v.x || c !== v.y) v.attr("x", b), c !== s && v.attr("y", c);
                v.x = b;
                v.y = c
            }
            function l(a, b) {
    ...
    if (!ca && !ha) S = {
        ...
        setSpanRotation: function () {
            var a = this.rotation,
                ...
                c = wa(a * Ba);
            G(this.element, {
                filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : U
            })
        },
        ...
        fillSetter: function (a, b, c) {
            ...
            else if (d !== "IMG") c.filled = a !== U, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
        },
        opacitySetter: aa,
    ...
    }, K.VMLElement = S = da(T, S), S.prototype.ySetter = S.prototype.widthSetter = S.prototype.heightSetter = S.prototype.xSetter, S = {
        Element: S,
        ...
        color: function (a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill") if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, o = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, x = 'angle="' + (90 - M.atan((n - a) / (o - c)) * 180 / gb) + '"', u();
                else {
                    var j = n.r,
                        t = j * 2,
                        w = j * 2,
                        ...
                        y, j = function () {
                            ...
                            x = 'src="' + F.global.VMLRadialGradientURL + '" size="' + t + "," + w + '" origin="0.5,0.5" position="' + B + "," + L + '" color2="' + Q + '" ';
                            u()
                        };
                    d.added ? j() : d.onAdd = j;
                    j = C
                } else j = k
            } else if (g.test(a) && b.tagName !== "IMG") f = fa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h), null, null, b), j = f.get("rgb");
            else {
        ...
        this.init.apply(this, arguments)
    }, Wa.prototype = y(ba.prototype, S), Ma = Wa;
    ...
    var Eb;
    if (ha) K.CanVGRenderer = S = function () {
        ya = "http://www.w3.org/1999/xhtml"
    }, S.prototype.symbols = {}, Eb = function () {
        function a() {
            var a = b.length,
                d;
            for (d = 0; d < a; d++) b[d]();
    ...
    Ka.prototype = {
        ...
        render: function (a, b, c) {
            ...
            if (n && Q) q === "inside" && (Q = -Q), d.opposite && (Q = -Q), h = this.getMarkPath(B, r, Q, n * L, g, f), o ? o.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(B)) i.xy = r = this.getLabelPosition(B, r, i, g, k, w, a, u), this.isFirst && !this.isLast && !m(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !m(e.showLastLabel, 1) ? t = !1 : !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && (t = this.handleOverflow(a, r)), u && a % u && (t = !1), t && !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr" : "animate"](r), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function () {
            $a(this, this.axis)
        }
    ...
    V.prototype = {
        ...
        init: function (a, b) {
            ...
            if (this.isLog) this.val2lin = Qa, this.lin2val = la
        },
        ...
        defaultLabelFormatter: function () {
            ...
            else if (f && a >= 1E3) for (; f-- && g === s;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = ua(b / c, -1) + e[f]);
        ...
        getSeriesExtremes: function () {
            ...
            p(a.series, function (c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && d <= 0 && (d = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = D(m(a.dataMin, d[0]), Ra(d)), a.dataMax = u(m(a.dataMax, d[0]), Ea(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (t(c) && t(e)) a.dataMin = D(m(a.dataMin, c), c), a.dataMax = u(m(a.dataMax, e), e);
        ...
        adjustForMinRange: function () {
            var a = this.options,
                ...
                f, g, h, i, j;
            if (this.isXAxis && this.minRange === s && !this.isLog) t(a.min) || t(a.max) ? this.minRange = null : (p(this.series, function (a) {
                i = a.xData;
                for (g = j = a.xIncrement ? 1 : i.length - 1; g > 0; g--) if (h = i[g] - i[g - 1], f === s || h < f) f = h
        ...
        setTickPositions: function (a) {
            ...
            if (e)!a && D(b.min, m(b.dataMin, b.min)) <= 0 && ma(10, 1), b.min = va(Qa(b.min)), b.max = va(Qa(b.max));
            if (b.range && t(b.max)) b.userMin = b.min = u(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
            ...
            if (ka(d.floor)) b.min = u(b.min, d.floor);
            if (ka(d.ceiling)) b.max = D(b.max, d.ceiling);
            b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : h && !l && o === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = m(l, J ? 1 : (b.max - b.min) * o / u(b.len, o)), !t(l) && b.len < o && !this.isRadial && !this.isLog && !J && d.startOnTick && d.endOnTick && (v = !0, b.tickInterval /= 4));
            ...
            if (!l && b.tickInterval < n) b.tickInterval = n;
            if (!f && !e && !l) b.tickInterval = pb(b.tickInterval, null, M.pow(10, ea(M.log(b.tickInterval) / M.LN10)), d);
            ...
            if (!h) e = a[0], f = a[a.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), d.endOnTick ? b.max = f : b.max + h < f && a.pop(), a.length === 1 && (d = P(b.max) > 1E13 ? 1 : 0.001, b.min -= d, b.max += d)
        },
        ...
        adjustTickAmount: function () {
            ...
            if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !== !1 && this.min !== s) {
                ...
                if (e < a) {
                    for (; b.length < a;) b.push(va(b[b.length - 1] + this.tickInterval));
                    this.transA *= (e - 1) / (a - 1);
        ...
        getOffset: function () {
            ...
            if (j || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && w && !J.rotation) {
                    for (j = a.reversed ? [].concat(e).reverse() : e; r < w;) {
                        y = [];
                        A = !1;
                        for (q = 0; q < j.length; q++) B = j[q], L = (L = f[B].label && f[B].label.getBBox()) ? L.width : 0, z = q % r, L && (B = a.translate(B), y[z] !== s && B < y[z] && (A = !0), y[z] = B + L);
                        if (A) r++;
                        else break
                    }
                    if (r > 1) a.staggerLines = r
                }
                p(e, function (b) {
                    if (h === 0 || h === 2 || {
                        1: "left",
                        3: "right"
                    }[h] === a.labelAlign) C = u(f[b].getLabelSize(), C)
                });
                if (a.staggerLines) C *= a.staggerLines, a.labelOffset = C
            ...
            if (v && v.text && v.enabled !== !1) {
                ...
                if (k) l = a.axisTitle.getBBox()[g ? "height" : "width"], n = v.offset, o = t(n) ? 0 : m(v.margin, g ? 5 : 10);
        ...
        render: function () {
            ...
            if (q || h) if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function (b) {
                ...
                if (!h || b >= a.min && b <= a.max) l[b] || (l[b] = new Ka(a, b)), x && l[b].isNew && l[b].render(c, !0, 0.1), l[b].render(c)
            }), C && a.min === 0 && (l[-1] || (l[-1] = new Ka(a, -1, null, !0)), l[-1].render(-1))), J && p(i, function (b, c) {
                if (c % 2 === 0 && b < a.max) o[b] || (o[b] = new K.PlotLineOrBand(a)), r = b + C, B = i[c + 1] !== s ? i[c + 1] + C : a.max, o[b].options = {
                    from: g ? la(r) : r,
                    to: g ? la(B) : B,
                    color: J
            ...
            if (Q) b = a.getLinePath(Q), a.axisLine ? a.axisLine.animate({
                d: b
        ...
        drawCrosshair: function (a, b) {
            if (this.crosshair) if ((t(b) || !m(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
            else {
    ...
    V.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5) a = w(a), g = this.getLinearTickPositions(a, b, c);
            ...
            i = e.length;
            for (h = 0; h < i && !l; h++) j = Qa(la(f) * e[h]), j > b && (!d || k <= c) && k !== s && g.push(k), k > c && (l = !0), k = j
        } else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = m(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = pb(a, null, M.pow(10, ea(M.log(a) / M.LN10))), g = Ua(this.getLinearTickPositions(a, b, c), Qa), !d) this._minorAutoInterval = a / 5;
    ...
    var na;
    Sa = A.documentElement.ontouchstart !== s;
    ...
    za.prototype = {
        ...
        runPointActions: function (a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                i = c.length;
                for (j = 0; j < i; j++) if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = P(l - e.clientX), k = D(k, e._dist), f.push(e);
            ...
            if (d && !this._onDocumentMouseMove) this._onDocumentMouseMove = function (a) {
                if (W[na]) W[na].pointer.onDocumentMouseMove(a)
        ...
        reset: function (a) {
            ...
            if (a) e.refresh(f), d && d.setState(d.state, !0);
                ...
                if (c) c.onMouseOut();
                e && e.hide();
                if (this._onDocumentMouseMove) Z(A, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
                p(b.axes, function (a) {
                    a.hideCrosshair()
                });
                this.hoverX = null
        ...
        drag: function (a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !m && !this.selectionMarker) this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
        ...
        inClass: function (a, b) {
            for (var c; a;) {
                if (c = N(a, "class")) if (c.indexOf(b) !== -1) return !0;
    ...
    if (H.PointerEvent || H.MSPointerEvent) {
        var sa = {},
            ...
            ob = function (a, b, c, d) {
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && W[na]) d(a), d = W[na].pointer, d[b]({
                    type: c,
    ...
    Xa.prototype = {
        init: function (a, b) {
            var c = this,
                ...
                f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = m(b.symbolWidth, 16), c.pages = [], c.render(), E(c.chart, "endResize", function () {
        ...
        renderItem: function (a) {
            ...
            if (!C) {
                ...
                if (!this.baseline) this.baseline = c.fontMetrics(h.fontSize, C).f + 3 + p, C.attr("y", this.baseline);
            ...
            if (e && this.itemX - J + f > (n || b.chartWidth - 2 * j - J - d.x)) this.itemX = J, this.itemY += p + this.lastLineHeight + o, this.lastLineHeight = 0;
        ...
        getAllItems: function () {
            ...
            p(this.chart.series, function (b) {
                var c = b.options;
                if (m(c.showInLegend, !t(c.linkedTo) ? s : !1, !0)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b))
            });
            return a
        },
        render: function () {
        ...
        scroll: function (a, b) {
            var c = this.pages,
                ...
                j = this.padding;
            e > d && (e = d);
            if (e > 0) b !== s && (ia = m(b, this.chart.animation)), this.nav.attr({
                translateX: j,
    ...
    pa.prototype = {
        init: function (a, b) {
            ...
            f.xAxis = [];
            f.yAxis = [];
            f.animation = ha ? !1 : m(d.animation, !0);
        ...
        redraw: function (a) {
            ...
            i && (p(b, function (a) {
                ...
                if (a.isDirtyExtremes) a.isDirtyExtremes = !1, v.push(function () {
        ...
        getChartSize: function () {
            ...
            if (!t(b)) this.containerWidth = cb(c, "width");
            if (!t(a)) this.containerHeight = cb(c, "height");
        ...
        getContainer: function () {
            ...
            e = "highcharts-" + ib++;
            if (Ca(a)) this.renderTo = a = A.getElementById(a);
            a || ma(13, !0);
        ...
        getMargins: function () {
            ...
            this.resetMargins();
            b = this.axisOffset;
            if (k && !t(d[0])) this.plotTop = u(this.plotTop, k + this.options.title.margin + a[0]);
            if (c.display && !e.floating) if (i === "right") {
                if (!t(d[1])) this.marginRight = u(this.marginRight, c.legendWidth - g + f + a[1])
            } else if (i === "left") {
                if (!t(d[3])) this.plotLeft = u(this.plotLeft, c.legendWidth + g + f + a[3])
            } else if (j === "top") {
                if (!t(d[0])) this.plotTop = u(this.plotTop, c.legendHeight + h + f + a[0])
            } else if (j === "bottom" && !t(d[2])) this.marginBottom = u(this.marginBottom, c.legendHeight - h + f + a[2]);
        ...
        setSize: function (a, b, c) {
            ...
            if (t(a)) d.chartWidth = e = u(0, w(a)), d.hasUserSize = !! e;
            if (t(b)) d.chartHeight = f = u(0, w(b));
            (ia ? db : G)(d.container, {
                width: e + "px",
                height: f + "px"
            }, ia);
        ...
        drawChartBox: function () {
            ...
            if (k) f ? f.animate(x) : this.plotBackground = b.rect(m, p, q, s, 0).attr({
                fill: k
            }).add().shadow(a.plotShadow);
            if (l) h ? h.animate(x) : this.plotBGImage = b.image(l, m, p, q, s).add();
            r ? r.animate({
                width: u.width,
                height: u.height
        ...
        firstRender: function () {
            ...
            if (a.isReadyToRender()) {
                ...
                a.linkSeries();
                I(a, "beforeRender");
                if (K.Pointer) a.pointer = new za(a, b);
                a.render();
                a.renderer.draw();
                c && c.apply(a, [a]);
    ...
    R.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) p(a, function (a, b) {
                ...
                if (v && h > v) {
                    ...
                    if (ka(k)) {
                        ...
                        for (c = 0; c < h; c++) q[c] = n, C[c] = a[c], n += i;
                        e.xIncrement = n
                    } else if (Ha(k)) if (r) for (c = 0; c < h; c++) i = a[c], q[c] = i[0], C[c] = i.slice(1, r + 1);
                    else for (c = 0; c < h; c++) i = a[c], q[c] = i[0], C[c] = i[1];
                    else ma(12)
        ...
        processData: function (a) {
            ...
            if (l && this.sorted && (!j || d > j || this.forceCrop)) if (n = h.getExtremes(), o = n.min, n = n.max, b[d - 1] < o || b[0] > n) b = [], c = [];
            else if (b[0] < o || b[d - 1] > n) e = this.cropData(this.xData, this.yData, o, n), b = e.xData, c = e.yData, e = e.start, f = !0, k = b.length;
            for (a = b.length - 1; a >= 0; a--) d = b[a] - b[a - 1], !f && b[a] > o && b[a] < n && k++, d > 0 && (g === s || d < g) ? g = d : d < 0 && this.requireSorting && ma(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function () {
            ...
            for (n = 0; n < g; n++) i = h + n, j ? l[n] = (new f).init(this, [d[n]].concat(oa(e[n]))) : (b[i] ? k = b[i] : a[i] !== s && (b[i] = k = (new f).init(this, a[i], d[n])), l[n] = k);
            if (b && (g !== (c = b.length) || j)) for (n = 0; n < c; n++) if (n === h && !j && (n += g), b[n]) b[n].destroyElements(), b[n].plotX = s;
            this.data = b;
            this.points = l
        },
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++) if (j = c[l], k = a[l], i = k !== null && k !== s && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j) if (i = k.length) for (; i--;) k[i] !== null && (e[f++] = k[i]);
            else e[f++] = k;
            this.dataMin = m(void 0, Ra(e));
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !! this.modifyValue, i = a.pointPlacement, j = i === "between" || ka(i), k = a.threshold, a = 0; a < g; a++) {
                ...
                if (b && this.visible && q && q[n]) q = q[n], o = q.points[this.index + "," + a], p = o[0], o = o[1], p === 0 && (p = m(k, e.min)), e.isLog && p <= 0 && (p = null), l.total = l.stackTotal = q.total, l.percentage = q.total && l.y / q.total * 100, l.stackY = o, q.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        animate: function (a) {
            ...
            var e = this.clipBox || b.clipBox,
                f = b.inverted,
                g;
            if (d && !ga(d)) d = X[this.type].animation;
        ...
        drawPoints: function () {
            ...
            var l = this.pointAttr[""],
                n, o = this.markerGroup,
                p = m(d.enabled, this.activePointCount < 0.5 * this.xAxis.len / d.radius);
            if (d.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = ea(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = p && i.enabled === s || i.enabled, n = c.isInsidePlot(w(d), e, c.inverted), a && e !== s && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = m(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[n ? "show" : "hide"](!0).animate(q({
                x: d - h,
                y: e - h
            }, k.symbolName ? {
                width: 2 * h,
                ...
                if (n && (h > 0 || j)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h).attr(a).add(o)
        ...
        getAttribs: function () {
            ...
            i = b.turboThreshold;
            var s;
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : e.color = e.color || fa(e.color || g).brighten(e.brightness).get();
            ...
            if (!i || g < i || k) for (; g--;) {
                ...
                if (i.options) for (s in l) t(c[l[s]]) && (k = !0);
                if (k) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
    ...
    q(R.prototype, {
        ...
        update: function (a, b) {
            ...
            this.remove(!1);
            for (i in g) g.hasOwnProperty(i) && (this[i] = s);
    ...
    O = da(R, {
        ...
        drawPoints: function () {
            ...
            p(a.points, function (h) {
                ...
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (Va(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](y(f))) : h.graphic = d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
        ...
        animate: function (a) {
            var b = this.yAxis,
                ...
                e = {};
            if (ca) a ? (e.scaleY = 0.001, a = D(b.pos + b.len, u(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function () {
            var a = this,
                b = a.chart;
    ...
    R.prototype.drawDataLabels = function () {
        var a = this,
            ...
            e = a.points,
            f, g, h, i;
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), !a.hasRendered && m(d.defer, !0) && (i.attr({
            opacity: 0
            ...
            if (l && !e) b.dataLabel = l.destroy();
                ...
                e = d.rotation;
                n = b.getLabelConfig();
                h = d.format ? Ia(d.format, n) : d.formatter.call(n, d);
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, w(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) d = q({
            ...
            align: c.align
        }) : (b.align(c, null, d), g = b.alignAttr, m(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : m(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)));
        if (!a) b.attr({
            y: -999
        }), b.placed = !1
    };
    ...
    if (r.pie) r.pie.prototype.drawDataLabels = function () {
        var a = this,
            b = a.data,
            c, d = a.chart,
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (I = 2; I--;) {
                ...
                if (H) {
                    ...
                    for (B = b = 0; !b && E[B];) b = E[B] && E[B].dataLabel && (E[B].dataLabel.getBBox().height || 21), B++;
                    if (l > 0) {
                        for (B = q - o - l; B <= q + o + l; B += b) F.push(B);
                        t = F.length;
                        if (H > t) {
                            c = [].concat(E);
                            c.sort(M);
                            for (B = H; B--;) c[B].rank = B;
                            for (B = H; B--;) E[B].rank >= t && E.splice(B, 1);
                            H = E.length
                        }
                        for (B = 0; B < H; B++) {
                            c = E[B];
                            ...
                            c = 9999;
                            var O, N;
                            for (N = 0; N < t; N++) O = P(F[N] - x[1]), O < c && (c = O, D = N);
                            if (D < B && F[B] !== null) D = B;
                            else for (t < H - B + D && F[B] !== null && (D = t - H + B); F[D] === null;) D++;
                            K.push({
                                i: D,
                                y: F[D]
                            });
                    ...
                    for (B = 0; B < H; B++) {
                        ...
                        c = x[1];
                        if (l > 0) {
                            if (t = K.pop(), D = t.i, z = t.y, c > z && F[D + 1] !== null || c < z && F[D - 1] !== null) z = c
                        } else z = c;
                        ...
                        r.connX = A;
                        r.connY = z;
                        if (this.options.size === null) t = r.width, A - t < f ? L[3] = u(w(t - A + f), L[3]) : A + t > h - f && (L[1] = u(w(A + t - h + f), L[1])), z - b / 2 < 0 ? L[0] = u(w(-z + b / 2), L[0]) : z + b / 2 > d && (L[2] = u(w(z + b / 2 - d), L[2]))
                    }
                }
            }
            if (Ea(L) === 0 || this.verifyDataLabelOverflow(L)) this.placeDataLabels(), s && g && p(this.points, function (b) {
                i = b.connector;
                x = b.labelPos;
                if ((r = b.dataLabel) && r._pos) G = r._attr.visibility, A = r.connX, z = r.connY, j = k ? ["M", A + (x[6] === "left" ? 5 : -5), z, "C", A, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", A + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({
                    d: j
    ...
    }, r.pie.prototype.alignDataLabel = aa, r.pie.prototype.verifyDataLabelOverflow = function (a) {
        var b = this.center,
            c = this.options,
            d = c.center,
            e = c = c.minSize || 80,
    ...
    if (r.column) r.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart,
            g = f.inverted,
    ...
    Y(V.prototype, "getSeriesExtremes", function (a) {
        ...
        if (b && (c = m(this.dataMin, Number.MAX_VALUE), d = m(this.dataMax, Number.MIN_VALUE), p(this.series, function (a, b) {
            if (a.useMapGeometry) c = Math.min(c, m(a.minX, c)), d = Math.max(d, m(a.maxX, c)), a.xData = e[b], f = !0
    ...
    Y(V.prototype, "setAxisTranslation", function (a) {
        var b = this.chart,
            ...
            d = b.xAxis[0];
        a.call(this);
        if (b.options.chart.preserveAspectRatio && this.coll === "yAxis" && d.transA !== s && (this.transA = d.transA = Math.min(this.transA, d.transA), a = c / ((d.max - d.min) / (this.max - this.min)), d = a < 1 ? this : d, a = (d.max - d.min) * d.transA, d.pixelPadding = d.len - a, d.minPixelPadding = d.pixelPadding / 2, a = d.fixTo)) {
    ...
    q(eb.prototype, {
        ...
        initDataClasses: function (a) {
            ...
            p(a.dataClasses, function (g, h) {
                var i, g = y(g);
                d.push(g);
                if (!g.color) f.dataClassColor === "category" ? (i = c.options.colors, g.color = i[e++], e === i.length && (e = 0)) : g.color = b.tweenColors(fa(f.minColor), fa(f.maxColor), h / (a.dataClasses.length - 1))
            })
        },
        ...
        drawCrosshair: function (a, b) {
            var c = !this.cross,
                ...
                f, g = this.pos,
                h = this.len;
            if (b) f = this.toPixels(b.value), f < g ? f = g - 2 : f > g + h && (f = g + h + 2), b.plotX = f, b.plotY = this.len - f, V.prototype.drawCrosshair.call(this, a, b), b.plotX = d, b.plotY = e, !c && this.cross && this.cross.attr({
                fill: this.crosshair.color
            }).add(this.labelGroup)
        },
        getPlotLinePath: function (a, b, c, d, e) {
            return e ? this.horiz ? ["M", e - 4, this.top - 6, "L", e + 4, this.top - 6, e, this.top, "Z"] : ["M", this.left, e, "L", this.left - 6, e + 6, this.left - 6, e - 6, "Z"] : V.prototype.getPlotLinePath.call(this, a, b, c, d)
        },
        update: function (a, b) {
            p(this.series, function (a) {
                a.isDirtyData = !0
    ...
    S = {
        ...
        translateColors: function () {
            ...
            p(this.data, function (d) {
                var e = d.value;
                if (e = e === null ? b : c && e !== void 0 ? c.toColor(e, d) : d.color || a.color) d.color = e
            })
        }
    };
    ...
    var Gb = da(ja, {
        applyOptions: function (a, b) {
            var c = ja.prototype.applyOptions.call(this, a, b),
                d = this.series,
                e = d.joinBy;
            if (d.mapData) if (e = c[e[1]] && d.mapMap[c[e[1]]]) {
    ...
    r.map = da(r.scatter, y(S, {
            ...
            p(a || [], function (a) {
                if (a.path) {
                    ...
                    var h = a.path || [],
                        ...
                        t = a.properties;
                    if (!a._foundBox) {
                        for (; i--;) typeof h[i] === "number" && !isNaN(h[i]) && (o ? (p = Math.max(p, h[i]), q = Math.min(q, h[i])) : (r = Math.max(r, h[i]), s = Math.min(s, h[i])), o = !o);
        ...
        translate: function () {
            ...
            p(a.data, function (d) {
                ...
                if (a.isDirtyData || a.chart.renderer.isVML) d.shapeType = "path", d.shapeArgs = {
        ...
        drawPoints: function () {
            ...
            }), this.group = this.transformGroup, r.column.prototype.drawPoints.apply(this), this.group = c, p(this.points, function (a) {
    ...
    q(pa.prototype, {
        renderMapNavigation: function () {
            ...
            if (m(b.enableButtons, b.enabled) && !a.renderer.forExport) for (d in c) if (c.hasOwnProperty(d)) f = y(b.buttonOptions, c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
                width: f.width,
                height: f.height,
    ...
    Y(pa.prototype, "render", function (a) {
        ...
        m(c.enableMouseWheelZoom, c.enabled) && E(b.container, document.onmousewheel === void 0 ? "DOMMouseScroll" : "mousewheel", function (a) {
    ...
    Y(za.prototype, "init", function (a, b, c) {
        a.call(this, b, c);
        if (m(c.mapNavigation.enableTouchZoom, c.mapNavigation.enabled)) this.pinchX = this.pinchHor = this.pinchY = this.pinchVert = !0
    });
    Y(za.prototype, "pinchTranslate", function (a, b, c, d, e, f, g) {
        a.call(this, b, c, d, e, f, g);
        this.chart.options.chart.type === "map" && (a = d.scaleX > d.scaleY, this.pinchTranslateDirection(!a, b, c, d, e, f, g, a ? d.scaleX : d.scaleY))
    });
    X.mapline = y(X.map, {
        lineWidth: 1,
        fillColor: "none"
    ...
    r.bubble = da(r.scatter, {
        ...
        getRadii: function (a, b, c, d) {
            ...
            for (f = 0, e = h.length; f < e; f++) g = b - a, g = g > 0 ? (h[f] - a) / (b - a) : 0.5, j && g >= 0 && (g = Math.sqrt(g)), i.push(M.ceil(c + g * (d - c)) / 2);
            this.radii = i
        },
        animate: function (a) {
            var b = this.options.animation;
            if (!a) p(this.points, function (a) {
                var d = a.graphic,
                    a = a.shapeArgs;
    ...
    V.prototype.beforePadding = function () {
        ...
        this.tickPositions && (p(this.series, function (b) {
            var d = b.options;
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries)) if (a.allowZoomOutside = !0, q.push(b), f) p(["minSize", "maxSize"], function (a) {
                var b = d[a],
                    c = /%$/.test(b),
                    b = z(b);
                i[a] = c ? j * b / 100 : b
            }), b.minPxSize = i.minSize, b = b.zData, b.length && (k = m(d.zMin, M.min(k, M.max(Ra(b), d.displayNegative === !1 ? d.zThreshold : -Number.MAX_VALUE))), l = m(d.zMax, M.max(l, Ea(b))))
        }), p(q, function (a) {
            var b = a[g],
                c = b.length,
                j;
            f && a.getRadii(k, l, i.minSize, i.maxSize);
            if (n > 0) for (; c--;) typeof b[c] === "number" && (j = a.radii[c], d = Math.min((b[c] - h) * o - j, d), e = Math.max((b[c] - h) * o + j, e))
        }), q.length && n > 0 && m(this.options.min, this.userMin) === s && m(this.options.max, this.userMax) === s && (e -= b, o *= (b + d - e) / b, this.min += d / o, this.max += e / o))
    };
    if (r.bubble) X.mapbubble = y(X.bubble, {
        animationLimit: 500,
        tooltip: {
    ...
    K.geojson = function (a, b, c) {
        ...
        if (c) c.chart.mapCredits = '<a href="http://www.ihme.com">IHME</a> © <a href="' + a.copyrightUrl + '">' + a.copyrightShort + "</a>";
        return d
    };
    Y(pa.prototype, "showCredits", function (a, b) {
        if (F.credits.text === this.options.credits.text && this.mapCredits) b.text = this.mapCredits, b.href = null;
        a.call(this, b)
    });
    q(F.lang, {
        zoomIn: "Zoom in",
    ...
    r.heatmap = da(r.scatter, y(S, {
        ...
        translate: function () {
            ...
            this.chart.hasRendered && p(this.points, function (a) {
    ...
    S = K.TrackerMixin = {
        ...
        drawTrackerGraph: function () {
            ...
            j ? j.attr({
                ...
                if (Sa) a.on("touchstart", o)
            }))
        }
    };
    if (r.column) O.prototype.drawTracker = S.drawTrackerPoint;
    if (r.pie) r.pie.prototype.drawTracker = S.drawTrackerPoint;
    if (r.scatter) ra.prototype.drawTracker = S.drawTrackerPoint;
    q(Xa.prototype, {
    ...
    q(ja.prototype, {
        ...
        setState: function (a, b) {
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic) g = g && this.graphic.symbolName && m.r, this.graphic.attr(y(m, g ? {
                    x: c - g,
                    y: d - g,
                    width: 2 * g,
                    height: 2 * g
                    ...
                    else if (l) e.stateMarkerGraphic = k = n.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(m).add(e.markerGroup), k.currentSymbol = l;
                    if (k) k[a && n.isInsidePlot(c, d, n.inverted) ? "show" : "hide"]()
                }
                if ((c = f[a] && f[a].halo) && c.size) {
                    if (!o) e.halo = o = n.renderer.path().add(e.seriesGroup);
                    o.attr(q({
        ...
        setTooltipPoints: function (a) {
            ...
            if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
                ...
                for (i = 0; i < a; i++) if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
                    h = b[i + 1];
                    c = d === s ? 0 : d + 1;
                    for (d = b[i + 1] ? D(u(0, ea((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && c <= d;) j[c++] = e
                }
