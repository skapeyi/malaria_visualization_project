...
<span class="empty"><?php echo $totalRows_case ?> records matched for <?php echo $r_case;?></span>
      <table width="100%" id="report">
      <tr>
        <td class="report-table-data-heads">District Name</td>
...
<?php } else { ?>
<div class="empty">No record found for <?php echo $r_case;?></div> 
<?php } ?>
<?php
